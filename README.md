...
Версия файлов типографских раскладок в большинстве случаев остаётся 1.0, но к номеру выпускаемой версии добавляется количество вошедших в неё раскладок. Например, `Typographic Keyboard 1.0-2` — две раскладки, Русская и США.
